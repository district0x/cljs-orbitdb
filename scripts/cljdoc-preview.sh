...
#        -p cljs-orbitdb/cljs-orbitdb
#        -v "$version" \
#        --jar /root/.m2/repository/repository/cljs-orbitdb/cljs-orbitdb/$version/cljs-orbitdb-$version.jar \
#        --pom /root/.m2/repository/cljs-orbitdb/cljs-orbitdb/$version/cljs-orbitdb-$version.pom  \
#        --git /cljs-orbitdb \
#        --rev "feature/cljdoc"
...
# http://localhost:8000/d/cljs-orbitdb/cljs-orbitdb/0.0.9-SNAPSHOT
# http://localhost:8000/d/cljs-orbitdb/cljs-orbitdb/0.0.9-SNAPSHOT/doc/readme
